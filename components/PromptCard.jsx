    ...
    <div className="prompt_card">
        ...
        <div className="flex-1 flex justify-start items-center gap-3 cursor-pointer">
          ...
          className="rounded-full object-contain"
           ...
           <div className='flex flex-col'>
            ...
            <p className='font-enter text-sm text-grey-500'>{post.creator.email}</p>
           </div>
        </div>
      ...
      {session?.user.id === post.creator._id && pathName === "/profile" && (
        <div className="mt-5 flex-center gap-4 border-t border-gray-500 pt-3">
          <p className="font-inter text-sm green_gradient cursor-pointer px-4" onClick={handleEdit}>Edit</p>
